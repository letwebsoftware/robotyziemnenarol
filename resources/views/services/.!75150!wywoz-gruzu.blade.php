...
<head>
    ...
    <title>Wywóz Gruzu Narol - Usuwanie Odpadów Budowlanych | Nisztuk</title>
    <meta name="description" content="Wywóz gruzu i humusu w Narolu - profesjonalne usuwanie odpadów budowlanych. Tel: 509 907 121">
...
<body class="bg-white text-gray-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <a href="/" class="flex items-center space-x-2">
                    <div class="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center text-xs font-black tracking-wide text-gray-900">NZ</div>
                    <div>
                        <h1 class="font-bold text-lg">NISZTUK</h1>
    ...
    <div class="bg-gray-50 py-4 px-4">
        <div class="max-w-7xl mx-auto">
            <a href="/" class="text-yellow-500 hover:text-yellow-600">Strona główna</a> / <span class="text-gray-600">Wywóz Gruzu</span>
        </div>
    </div>
