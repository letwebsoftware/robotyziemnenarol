...
<body class="bg-white text-gray-900">
    ...
    <section class="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-16 px-4">
        <div class="max-w-7xl mx-auto">
            <h1 class="text-5xl font-bold mb-4">Roboty Ziemne Narol</h1>
            <p class="text-xl text-gray-300">Profesjonalne prace ziemne, wykopy, i usługi koparką na terenie Narola i okolic</p>
        </div>
    </section>
    ...
    <div class="bg-gray-50 py-4 px-4">
        <div class="max-w-7xl mx-auto">
            <a href="/" class="text-yellow-500 hover:text-yellow-600">Strona główna</a> / <a href="/#uslugi" class="text-yellow-500 hover:text-yellow-600">Usługi</a> / <span class="text-gray-600">Roboty Ziemne</span>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid md:grid-cols-3 gap-12">
                ...
                <div class="md:col-span-2">
                    <h2 class="text-3xl font-bold mb-6">Czym Są Roboty Ziemne?</h2>
                    <p class="text-gray-700 mb-4 text-lg leading-relaxed">
                        Roboty ziemne to prace przygotowawcze poprzedzające każdą budowę. Obejmują one profesjonalne wykopalisko, niwelację terenu, transport materiałów i przygotowanie podłoża.
                    </p>
                    <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                        Nasze doświadczenie i nowoczesny sprzęt pozwalają nam realizować każdy projekt z najwyższą dokładnością i terminowo.
                    </p>
                    ...
                    <div class="space-y-6">
                        <div class="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-400">
                            <h3 class="text-2xl font-bold mb-2">Wykopy Pod Fundamenty</h3>
                            <p class="text-gray-700">
                                Precyzyjne wykopy pod fundamenty budynków, domów jednorodzinnych i konstrukcji przemysłowych. Gwarantujemy dokładność i bezpieczeństwo wykonania.
                            </p>
                        </div>

                        <div class="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-400">
                            <h3 class="text-2xl font-bold mb-2">Przyłącza Wodne i Kanalizacyjne</h3>
                            <p class="text-gray-700">
                                Profesjonalne wykopalisko i przygotowanie koryt dla systemów wodociągowych i kanalizacyjnych. Wszystkie prace zgodnie z normami budowlanymi.
                            </p>
                        </div>

                        <div class="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-400">
                            <h3 class="text-2xl font-bold mb-2">Korytowanie Dróg</h3>
                            <p class="text-gray-700">
                                Wyrównanie i przygotowanie podłoża dla nowych dróg, podjezdów i alejek. Pracujemy z dbałością o szczegóły.
                            </p>
                        </div>
                        ...
                        <div class="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-400">
                            ...
                            <p class="text-gray-700">
                                Niwelacja i podnoszenie wysokości terenu. Idealne rozwiązanie dla terenów zagrożonych zalaniem lub nieregularnych powierzchni.
                            </p>
                        </div>

                        <div class="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-400">
                            <h3 class="text-2xl font-bold mb-2">Przygotowanie Terenu Budowy</h3>
                            <p class="text-gray-700">
                                Pełne przygotowanie terenu do budowy - od usunięcia warstwy humusu, przez wyrównanie, aż do przywiezienia piasku i żwiru.
                            </p>
                        </div>
                    </div>
                    ...
                    <ul class="space-y-4 text-lg text-gray-700">
                        ...
                        <li class="flex items-start space-x-3">
                            <span class="text-2xl text-yellow-400">✓</span>
                            <span>Nowoczesny i sprawny sprzęt</span>
                        </li>
                        <li class="flex items-start space-x-3">
                            <span class="text-2xl text-yellow-400">✓</span>
                            <span>Zespół doświadczonych pracowników</span>
                        </li>
                        <li class="flex items-start space-x-3">
                            <span class="text-2xl text-yellow-400">✓</span>
                        ...
                        <li class="flex items-start space-x-3">
                            <span class="text-2xl text-yellow-400">✓</span>
                            <span>Gwarancja jakości wykonania</span>
                        </li>
                    </ul>

                    <h2 class="text-3xl font-bold mb-6 mt-10">Galeria - Roboty Ziemne</h2>
                    <div class="grid md:grid-cols-2 gap-6">
                        <img src="/images/fundamenty_wykop.jpeg" alt="Wykop pod fundamenty Narol" class="rounded-lg shadow-md h-64 object-cover">
                        <img src="/images/fundamenty_wykop_2.jpeg" alt="Roboty ziemne Narol" class="rounded-lg shadow-md h-64 object-cover">
                        <img src="/images/koparka.jpeg" alt="Koparka przy pracy" class="rounded-lg shadow-md h-64 object-cover">
                        <img src="/images/minikoparka.jpeg" alt="Minikoparka do prac ziemnych" class="rounded-lg shadow-md h-64 object-cover">
                    </div>
                </div>
                ...
                <div>
                    <div class="bg-yellow-50 p-8 rounded-lg shadow-md sticky top-24">
                        <h3 class="text-2xl font-bold mb-4">Potrzebujesz Wyceny?</h3>
