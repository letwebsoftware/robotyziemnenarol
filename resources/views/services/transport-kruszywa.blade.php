...
<head>
    ...
    <title>Transport Kruszywa Narol - Piasek, Żwir, Dostawa | Nisztuk</title>
    <meta name="description" content="Transport kruszywa w Narolu - dostawa piasku, żwiru i materiałów budowlanych. Tel: 509 907 121">
                    ...
                    <div class="bg-blue-50 p-6 rounded-lg mb-6">
                        <ol class="space-y-4 text-lg text-gray-700">
                            <li class="flex items-start space-x-3">
                                ...
                                <span><strong>Zadzwoń do nas</strong> - 509 907 121 i opisz swoją potrzebę</span>
                            </li>
                            <li class="flex items-start space-x-3">
