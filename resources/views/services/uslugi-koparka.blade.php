...
<head>
    ...
    <title>Usługi Koparką Narol - Niwelacja Terenu, Wykopy | Nisztuk</title>
    <meta name="description" content="Usługi koparką w Narolu - niwelacja terenu, wykopy, podnoszenie terenu. Tel: 509 907 121">
...
<body class="bg-white text-gray-900">
    ...
    <div class="bg-gray-50 py-4 px-4">
        <div class="max-w-7xl mx-auto">
            <a href="/" class="text-yellow-500 hover:text-yellow-600">Strona główna</a> / <span class="text-gray-600">Usługi Koparką</span>
        </div>
    </div>
